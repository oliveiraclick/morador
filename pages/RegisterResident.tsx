...
import { ArrowLeft, User, MapPin, Lock, Mail, Building, Home } from 'lucide-react';
...
const RegisterResident: React.FC = () => {
    ...
    const [condo, setCondo] = useState(''); // Stores Condo ID now
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 focus:outline-none appearance-none bg-white text-gray-700"
                            >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="col-span-2 space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input required type="text" value={street} onChange={e => setStreet(e.target.value)} className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 focus:outline-none" placeholder="Nome da rua" />
                            </div>
                        </div>
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input required type="text" value={number} onChange={e => setNumber(e.target.value)} className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 focus:outline-none" placeholder="123" />
                            </div>
                        </div>
                    </div>
